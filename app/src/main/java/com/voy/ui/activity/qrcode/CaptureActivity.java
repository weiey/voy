package com.voy.ui.activity.qrcode;
...
import com.voy.R;
import com.voy.ui.activity.base.BaseSwipeBackCompatActivity;
import com.voy.ui.activity.qrcode.camera.CameraManager;
import com.voy.ui.activity.qrcode.decode.DecodeThread;
import com.voy.ui.activity.qrcode.decode.DecodeUtils;
import com.voy.ui.activity.qrcode.utils.BeepManager;
import com.voy.ui.activity.qrcode.utils.InactivityTimer;
                ...
                ImageLoader.getInstance().loadImage("file://" + imagePath, new ImageLoadingListener() {
                    ...
                    public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                        ...
                        if (!TextUtils.isEmpty(resultZbar)) {
                            ...
                            ToastUtils.showToast(CaptureActivity.this, getResources().getString(R.string.tips_decode_null));
                        }
                    }
